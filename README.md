...
- Implemented user interface to select files from the file system in order to attach them to an outgoing message.
- Researched and implemented mechanism to embed binary/text attachment to an outgoing email.
