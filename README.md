...
- TODO: Implement user interface to save the attached files to the file system (Yong).
- TODO: Implement user interface to select files from the file system (Yoo Min).
- TODO: Research and implement mechanism to embed binary attachment to an outgoing email (Yoo Min).
